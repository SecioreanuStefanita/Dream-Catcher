...
################################################################################
## Form generated from reading UI file 'newMainWindowcBBRPC.ui'
##
...
"background-color: rgb(210, 96, 42);")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 354, 105))
...
"background-color: rgb(210, 96, 42);")
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 354, 104))
...
"background-color: rgb(210, 96, 42);")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 372, 345))
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QRect(0, 0, 354, 269))
...
"background-color: rgb(210, 96, 42);")
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QRect(0, -224, 364, 867))
...
"border-radius:16px;")
        ...
        self.scrollAreaWidgetContents_7.setGeometry(QRect(0, 0, 353, 107))
...
"background-color: rgb(210, 96, 42);")
        ...
        self.scrollAreaWidgetContents_6.setGeometry(QRect(0, 0, 364, 560))
...
"border-radius:16px;")
        ...
        self.mainPages.setCurrentIndex(8)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_19.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>For the next steps please press the button below to open up a terminal. Then type the following command to enter via SSH on a Linode hosted machine that has the server script. Input the following command: <span style=\" color:#d2602a;\">ssh root@194.233.170.11</span> then please type in the password: <span style=\" color:#d2602a;\">vrmYkKqj@4dxkr* </span><span style=\" color:#ffffff;\">. Then type in </span><span style=\" color:#d2602a;\">./server</span><span style=\" color:#ffffff;\"> to start the server and listen for incoming connections.  In case the output is not Emails were sent successfully there was an error sending emails, please correct the error in order to proceed.</span></p></body></html>", None))
